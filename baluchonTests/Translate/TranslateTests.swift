...
//        let translateService = NetworkService(session: URLSessionFake(data: nil, error: MyError()))
...
//        let translateService = NetworkService(session: URLSessionFake(data: data, error: nil))
//        translateService.getTranslation(for: "Bonjour", from: "FR", to: "EN") { result in
//            switch result {
//            case .success:
//                break
...
//
//    func testUrlError() {
//        let translateService = NetworkService(session: URLSessionFake(data: nil, error: nil))
//

...
class TranslateService {
    ...
    func gettranslation(for queryText: String,
       ...
       let ApiUrl =  "https://translation.googleapis.com/language/translate/v2?key=\(apiKey)&format=\(format)&q=\(queryText)&target=\(target)&source=\(source)"
        
        NetworkService.shared.launchAPICall(url: ApiUrl, expectingReturnType: TranslateStruct.self, completion: { result in
            switch result {
